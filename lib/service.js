...
`.trim();
    ...
    // ✅ UPDATED: not forcing counts; allow professional variability
...
`.trim();
    ...
    // ✅ Audio report uses TEXT model for the final report (still GPT-5.1)
    // (Transcription remains whisper-1)
    const maxTokens = depth === "deep" ? 1800 : 1300;
